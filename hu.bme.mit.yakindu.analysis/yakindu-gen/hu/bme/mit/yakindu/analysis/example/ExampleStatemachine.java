...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_TrapState:
				...
				break;
			case main_region_TrapState2:
				main_region_TrapState2_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_TrapState2:
			return stateVector[0] == State.main_region_TrapState2;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state TrapState2 */
	private void enterSequence_main_region_TrapState2_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_TrapState2;
	}
	...
	/* Default exit sequence for state TrapState2 */
	private void exitSequence_main_region_TrapState2() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_TrapState:
			...
			break;
		case main_region_TrapState2:
			exitSequence_main_region_TrapState2();
			break;
		default:
			break;
		}
			...
			if (react()==false) {
				if (sCInterface.black) {
					...
					if (timeEvents[0]) {
						...
						if (sCInterface.trap1) {
							exitSequence_main_region_Black();
							enterSequence_main_region_TrapState_default();
						} else {
							if (sCInterface.trap1) {
								exitSequence_main_region_Black();
								enterSequence_main_region_TrapState2_default();
							} else {
								did_transition = false;
							}
						}
	...
	private boolean main_region_TrapState2_react(boolean try_transition) {
		boolean did_transition = try_transition;
